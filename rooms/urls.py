...
urlpatterns = [
    ...
    path("<int:room_pk>/photos/<int:photo_pk>/delete/", views.delete_photo, name="delete_photos"),   
    path("search/", views.SearchView.as_view(), name="search"),
    path("<int:room_pk>/photos/<int:photo_pk>/edit/", views.EditPhotoView.as_view(), name="edit_photos"),   
]
